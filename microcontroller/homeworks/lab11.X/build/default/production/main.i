...
void main(void)
{
    ...
    while(1) {
        ...
        else if(strstr(GetString(),"breath")!=((void*)0)) breathe();


        else if(strstr(GetString(),"music")){
            if(strstr(GetString(),"music 1")!=((void*)0)) PlaySound(1);
            else if(strstr(GetString(),"music 2")!=((void*)0)) PlaySound(2);
        }

        else if(strstr(GetString(),"blink")){
            mode1=1;
            if(strstr(GetString(),"blink 1")!=((void*)0)){
                if(strstr(GetString(),"blink 1 1")!=((void*)0))BlinkLight(1,1);
                else if(strstr(GetString(),"blink 1 2")!=((void*)0))BlinkLight(1,2);
                else if(strstr(GetString(),"blink 1 3")!=((void*)0)) BlinkLight(1,3);
                else if(strstr(GetString(),"blink 1 4")!=((void*)0)) BlinkLight(1,4);
            }
            else if(strstr(GetString(),"blink 2")!=((void*)0)) {
                if(strstr(GetString(),"blink 2 1")!=((void*)0)) BlinkLight(2,1);
                else if(strstr(GetString(),"blink 2 2")!=((void*)0)) BlinkLight(2,2);
                else if(strstr(GetString(),"blink 2 3")!=((void*)0)) BlinkLight(2,3);
                else if(strstr(GetString(),"blink 2 4")!=((void*)0)) BlinkLight(2,4);
            }
            else if(strstr(GetString(),"blink 3")!=((void*)0)){
                if(strstr(GetString(),"blink 3 1")!=((void*)0)) BlinkLight(3,1);
                else if(strstr(GetString(),"blink 3 2")!=((void*)0)) BlinkLight(3,2);
                else if(strstr(GetString(),"blink 3 3")!=((void*)0)) BlinkLight(3,3);
                else if(strstr(GetString(),"blink 3 4")!=((void*)0)) BlinkLight(3,4);
            }
            else if(strstr(GetString(),"blink 4")!=((void*)0)){
                if(strstr(GetString(),"blink 4 1")!=((void*)0)) BlinkLight(4,1);
                else if(strstr(GetString(),"blink 4 2")!=((void*)0)) BlinkLight(4,2);
                else if(strstr(GetString(),"blink 4 3")!=((void*)0)) BlinkLight(4,3);
                else if(strstr(GetString(),"blink 4 4")!=((void*)0)) BlinkLight(4,4);
            }

        }

        else if(strstr(GetString(),"s")!=((void*)0)&&mode3==1){ StopSound();}
        else if(strstr(GetString(),"p")!=((void*)0)){ PlaySound(tone_index+1); }

    }
    return;
}

void __attribute__((picinterrupt(""))) tc_int(void)
{
    if(PIR2bits.TMR3IF){
        PIR2bits.TMR3IF=0;
    }
